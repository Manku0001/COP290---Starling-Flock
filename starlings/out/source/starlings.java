...
class Flock {
  ...
  public void run() {
    ...
    RunParallel p1 = new RunParallel(0, PApplet.parseInt(count/4), boids);
    RunParallel p2 = new RunParallel(PApplet.parseInt(count/4), PApplet.parseInt(2*count/4), boids);
    RunParallel p3 = new RunParallel(PApplet.parseInt(2*count/4), PApplet.parseInt(3*count/4), boids);
    RunParallel p4 = new RunParallel(PApplet.parseInt(3*count/4), count, boids);
